...
export function IsoIdentityBanner() {
  return (
    <section className="bg-primary text-primary-foreground py-8 sm:py-10 px-4 sm:px-6">
      <div className="container mx-auto flex flex-col items-center justify-center gap-4 sm:gap-6 md:flex-row md:gap-12">
        <motion.div
        ...
        >
          <Wrench size={40} className="opacity-90 md:w-12 md:h-12" />
        </motion.div>
      </div>
    </section>
  )
